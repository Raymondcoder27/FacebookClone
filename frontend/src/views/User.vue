                        ...
                        <div class="flex md:flex-row flex-col gap-4 md:-mt-6 -mt-16 items-center">
                            ...
                            <div class="md:mt-4 text-center md:text-left -mt-3">
                                ...
                                <div class="flex md:justify-start justify-center md:-mt-1">
                                    ...
                                    <img src="https://picsum.photos/id/142/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[9] w-[40px]">
                                    <img src="https://picsum.photos/id/143/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[8] w-[40px]">
                                    <img src="https://picsum.photos/id/144/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[7] w-[40px]">
                                    <img src="https://picsum.photos/id/145/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[6] w-[40px]">
                                    <img src="https://picsum.photos/id/146/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[5] w-[40px]">
                                    <img src="https://picsum.photos/id/147/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[4] w-[40px]">
                                    <img src="https://picsum.photos/id/148/500/500" alt="" class="rounded-full -ml-1 boarder-white border-2 z-[3] w-[40px]">
                                </div>
                            </div>
                        </div>
                    </div>
